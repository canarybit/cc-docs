...
[CanaryBit Surveyor](./surveyor.md) helps to correctly configure the containerisation platform and enforces CanaryBit Inspector Remote Attestation before containers/pods execution.  
...
The _Policy Generator_ and _Policy Playground_ in the CanaryBit Inspector [dashboard](https://dashboard.inspector.confidentialcloud.io) help you define custom policies according to the exposed CanaryBit Inspector report object schema. 

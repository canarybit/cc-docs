...
- **Cache**: it optimises the retrieval of hardware certificates (leaf, intermediate and root) and relevant assets needed for cryptographic verification of the attestation reports generated by Confidential Computing-capable processing units. <br>
[https://cbcs.inspector.confidentialcloud.io](https://cbcs.inspector.confidentialcloud.io)
